...
// Flee breaks off through a random exit, taking one free counter-attack.
func (a *App) Flee() (protocol.FleeReply, error) {
	return decode[protocol.FleeReply](a, protocol.Command{Verb: protocol.VerbFlee})
}
